...
def run_worker(model_size, batch_size, bptt, optimizer_type, lr_schedule, precision, n_epochs=10):
    ...
    nlayers = 4 # the number of nn.TransformerEncoderLayer in nn.TransformerEncoder, was 8
    nhead = 4 # the number of heads in the Multihead Attention models, was 16
    dropout = 0.2 # the dropout value remains the same
                ...
                for optimizer_type in optimizer_types:
                    for lr_schedule in lr_schedules:
                        for precision in precisions:
                            ...
                            # results[key] = run_worker(model_size, batch_size, bptt, optimizer_type, lr_schedule, precision, n_epochs=3)
                            # run_worker(model_size, batch_size, bptt, optimizer_type, lr_schedule, precision, n_epochs=3)
